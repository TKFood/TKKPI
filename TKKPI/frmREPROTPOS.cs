...
namespace TKKPI
{
    public partial class frmREPROTPOS : Form
    {
        ...
        public void Search3(string MNAMES)
        {
        ...
        public void SETFASTREPORT8(string ID)
        {
            ...
            report1.Load(@"REPORT\營銷-POS活動品號.frx");
        ...
        public void SETFASTREPORT9(string SDATES, string EDATES, string ID)
        {
            ...
            report1.Load(@"REPORT\營銷-POS活動每日總金額.frx");
        ...
        public void SETFASTREPORT10(string SDATES, string EDATES, string ID)
        {
            ...
            report1.Load(@"REPORT\營銷-POS活動每日明細.frx");
        ...
        public void ADDSSALESPROJECTSINVMB(string MNAMES,
                              string MB001,
                              string MB002
                             )
        {
            ...
            try
            {
                ...
                sbSql.AppendFormat(@" 
                                    INSERT INTO  [TKKPI].[dbo].[SALESPROJECTSINVMB]
                                    ([MNAMES],[MB001],[MB002])
                                    VALUES
                                    ('{0}','{1}','{2}')
        ...
        private void dataGridView3_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (dataGridView3.CurrentRow != null)
            {
                ...
                if (rowindex >= 0)
                {
                    ...
                    Search3(row.Cells["調整事項"].Value.ToString());
        ...
        {
            ADDSSALESPROJECTSINVMB(textBox7.Text.Trim(), textBox8.Text.Trim(), textBox9.Text.Trim());

            Search3(textBox7.Text.Trim());
        }
