    ...
    public partial class frmREPORTSASLACOPTCTD : Form
    {
        ...
        public StringBuilder SETSQL(string KINDS, string LA007, string TC004, string P1, string P2, string P3, string P4, string P5, string P6)
        {
            ...
            SB.AppendFormat(@" 
                            ...
                            ,(SELECT ISNULL(SUM(TD008),0) FROM [TK].dbo.COPTC,[TK].dbo.COPTD WHERE TC001=TD001 AND TC002=TD002 AND TC001='A228' AND TC027='Y' AND TC004=@TC004 AND SUBSTRING(TD013,1,6)=@THISYEARLASTMONTH AND TD004=LA005 ) AS 'LASTMONTHNUMS'
                            ,(SELECT ISNULL(SUM(TD012),0) FROM [TK].dbo.COPTC,[TK].dbo.COPTD WHERE TC001=TD001 AND TC002=TD002  AND TC001='A228' AND TC027='Y' AND TC004=@TC004 AND SUBSTRING(TD013,1,6)=@THISYEARLASTMONTH AND TD004=LA005 ) AS 'LASTMONTHMONEYS'
                            ...
                            ,(SELECT ISNULL(SUM(TD008),0) FROM [TK].dbo.COPTC,[TK].dbo.COPTD WHERE TC001=TD001 AND TC002=TD002  AND TC001='A228' AND TC027='Y' AND TC004=@TC004 AND SUBSTRING(TD013,1,6)=@THISYEARTHISMONTH AND TD004=LA005 ) AS 'THISMONTHNUMS'
                            ,(SELECT ISNULL(SUM(TD012),0) FROM [TK].dbo.COPTC,[TK].dbo.COPTD WHERE TC001=TD001 AND TC002=TD002  AND TC001='A228' AND TC027='Y' AND TC004=@TC004 AND SUBSTRING(TD013,1,6)=@THISYEARTHISMONTH AND TD004=LA005 ) AS 'THISMONTHMONEYS'
                            ...
                            ,(SELECT ISNULL(SUM(TD008),0) FROM [TK].dbo.COPTC,[TK].dbo.COPTD WHERE TC001=TD001 AND TC002=TD002 AND TC001='A228' AND TC027='Y' AND TC004=@TC004 AND SUBSTRING(TD013,1,6)=@THISYEARNEXTMONTH AND TD004=LA005 ) AS 'NEXTMONTHNUMS'
                            ,(SELECT ISNULL(SUM(TD012),0) FROM [TK].dbo.COPTC,[TK].dbo.COPTD WHERE TC001=TD001 AND TC002=TD002 AND TC001='A228' AND TC027='Y'  AND TC004=@TC004 AND SUBSTRING(TD013,1,6)=@THISYEARNEXTMONTH AND TD004=LA005 ) AS 'NEXTMONTHMONEYS'
                            FROM (
                            SELECT LA005
                            FROM (
                            --去年的銷售商品
