...
namespace TKKPI
{
    public partial class frmECOMMERCE : Form
    {
        ...
        public StringBuilder SETsbSql()
        {
            ...
            {
                STR.Append(@" SELECT 今年,月份,(總合-橘點子) '總計',(WEB-蝦皮-YAHOO-PCHOME-MOMO-神坊-樂天-自游邦) AS '官網',(總合-橘點子-WEB-蝦皮-YAHOO-PCHOME-MOMO-神坊-樂天-自游邦) AS '消費者',蝦皮,MOMO,YAHOO,PCHOME,神坊,樂天,自游邦");
                STR.Append(@" FROM (");
                STR.Append(@" SELECT ID AS '月份'");
                STR.Append(@" ,CAST(YEAR(GETDATE()) AS NVARCHAR)+ID  AS  '今年'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK), [TK].[dbo].[ACTTA] WITH (NOLOCK) WHERE TA001=TB001 AND TA002=TB002 AND TA010='Y' AND TB005='411104' AND TB006 NOT IN ('106200') AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0)) AS '總合'");
                ...
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TH013) FROM  [TK].dbo.COPTH WITH (NOLOCK) WHERE  TH020='Y' AND TH005 NOT LIKE '%手續%'AND TH005 NOT LIKE '%運費%' AND (TH001='A233' OR TH001='A234') AND TH002 LIKE  CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'  ),0)) 'WEB'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK) WHERE TB005='411104' AND TB006 IN ('106400','102300','114000') AND (TB010 LIKE '%蝦皮%')  AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0))  AS '蝦皮'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK) WHERE TB005='411104' AND TB006 IN ('106400','102300','114000') AND (TB010 LIKE '%YAHOO%' OR TB010 LIKE '%yahoo%')  AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0))  AS 'YAHOO'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK) WHERE TB005='411104' AND TB006 IN ('106400','102300','114000') AND (TB010 LIKE '%MOMO%')  AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0))  AS 'MOMO'                ");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK) WHERE TB005='411104' AND TB006 IN ('106400','102300','114000') AND (TB010 LIKE '%pc%' OR  TB010 LIKE '%Pc%'  OR  TB010 LIKE '%PC%' ) AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0)) AS 'PCHOME'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK) WHERE TB005='411104' AND TB006 IN ('106400','102300','114000') AND (TB010 LIKE '%神坊%')  AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0)) AS '神坊'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK) WHERE TB005='411104' AND TB006 IN ('106400','102300','114000') AND (TB010 LIKE '%樂天%')  AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0))  AS '樂天'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK) WHERE TB005='411104' AND TB006 IN ('106400','102300','114000') AND (TB010 LIKE '%自游邦%')  AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0))  AS '自游邦'");
                STR.Append(@" FROM [TKECOMMERCE].dbo.BASEMONTH ) AS TEMP");
                STR.Append(@" ");
            ...
            else if (comboBox1.Text.ToString().Equals("每月現銷銷貨"))
            {
                ...
                STR.AppendFormat(@" ,CASE WHEN ID<=MONTH(GETDATE()) THEN ISNULL((SELECT SUM(LA011) FROM  [TK].dbo.COPTH WITH (NOLOCK),[TK].dbo.INVLA WITH (NOLOCK),[TK].dbo.COPTG WITH (NOLOCK)  WHERE TG001=TH001 AND TG002=TH002 AND  TH020='Y' AND TH001=LA006 AND TH002=LA007 AND TH003=LA008 AND SUBSTRING(TH002,1,4)=CAST(YEAR(GETDATE()) AS NVARCHAR) AND SUBSTRING(TH002,1,6)=CAST(YEAR(GETDATE()) AS NVARCHAR)+ID AND TH001='A230' AND TG005 IN ('102300','114000')          ),0) ELSE 0 END AS '本月出貨量' ");
                STR.AppendFormat(@" ,CASE WHEN ID<=MONTH(GETDATE()) THEN ISNULL((SELECT SUM(LA011) FROM  [TK].dbo.COPTJ WITH (NOLOCK),[TK].dbo.INVLA WITH (NOLOCK),[TK].dbo.COPTI WITH (NOLOCK)  WHERE TI001=TJ001 AND TI002=TJ002 AND TJ021='Y' AND TJ001=LA006 AND TJ002=LA007 AND TJ003=LA008 AND SUBSTRING(TJ002,1,4)=CAST(YEAR(GETDATE()) AS NVARCHAR) AND   SUBSTRING(TJ002,1,6)=CAST(YEAR(GETDATE()) AS NVARCHAR)+ID AND TJ001='A240'  AND TI005 IN ('102300','114000')   ),0)  ELSE 0 END AS '本月退貨量' ");
                STR.AppendFormat(@" ,CASE WHEN ID<=MONTH(GETDATE()) THEN ISNULL((SELECT SUM(TH013) FROM  [TK].dbo.COPTH WITH (NOLOCK),[TK].dbo.COPTG WITH (NOLOCK)  WHERE TG001=TH001 AND TG002=TH002 AND   TH020='Y' AND SUBSTRING(TH002,1,4)=CAST(YEAR(GETDATE()) AS NVARCHAR) AND SUBSTRING(TH002,1,6)=CAST(YEAR(GETDATE()) AS NVARCHAR)+ID  AND TH001='A230'  AND TG005 IN ('102300','114000')  ),0) ELSE 0 END AS '本月出貨金額' ");
                STR.AppendFormat(@" ,CASE WHEN ID<=MONTH(GETDATE()) THEN ISNULL((SELECT SUM(TJ012) FROM  [TK].dbo.COPTJ WITH (NOLOCK),[TK].dbo.COPTI WITH (NOLOCK)  WHERE TI001=TJ001 AND TI002=TJ002 AND  TJ021='Y' AND SUBSTRING(TJ002,1,4)=CAST(YEAR(GETDATE()) AS NVARCHAR) AND SUBSTRING(TJ002,1,6)=CAST(YEAR(GETDATE()) AS NVARCHAR)+ID AND TJ001='A240' AND TI005 IN ('102300','114000')   ),0)  ELSE 0 END AS '本月退貨金額' ");
                STR.AppendFormat(@" ,CAST(YEAR(GETDATE())-1 AS NVARCHAR)+ID  AS '去年' ");
                STR.AppendFormat(@" ,ISNULL((SELECT SUM(LA011) FROM  [TK].dbo.COPTH WITH (NOLOCK),[TK].dbo.INVLA WITH (NOLOCK),[TK].dbo.COPTG WITH (NOLOCK)  WHERE TG001=TH001 AND TG002=TH002 AND  TH020='Y' AND TH001=LA006 AND TH002=LA007 AND TH003=LA008 AND SUBSTRING(TH002,1,4)=CAST(YEAR(GETDATE())-1 AS NVARCHAR) AND SUBSTRING(TH002,1,6)=CAST(YEAR(GETDATE())-1 AS NVARCHAR)+ID AND TH001='A230'  AND TG005 IN ('102300','114000') ),0) AS '去年本月出貨量' ");
                STR.AppendFormat(@" ,ISNULL((SELECT SUM(LA011) FROM  [TK].dbo.COPTJ WITH (NOLOCK),[TK].dbo.INVLA WITH (NOLOCK),[TK].dbo.COPTI WITH (NOLOCK)  WHERE TI001=TJ001 AND TI002=TJ002 AND  TJ021='Y' AND TJ001=LA006 AND TJ002=LA007 AND TJ003=LA008 AND SUBSTRING(TJ002,1,4)=CAST(YEAR(GETDATE())-1 AS NVARCHAR) AND   SUBSTRING(TJ002,1,6)=CAST(YEAR(GETDATE())-1 AS NVARCHAR)+ID AND TJ001='A240' AND TI005 IN ('102300','114000')  ),0)   AS '去年本月退貨量'");
                STR.AppendFormat(@" ,ISNULL((SELECT SUM(TH013) FROM  [TK].dbo.COPTH WITH (NOLOCK),[TK].dbo.COPTG WITH (NOLOCK)  WHERE TG001=TH001 AND TG002=TH002 AND  TH020='Y' AND SUBSTRING(TH002,1,4)=CAST(YEAR(GETDATE())-1 AS NVARCHAR) AND SUBSTRING(TH002,1,6)=CAST(YEAR(GETDATE())-1 AS NVARCHAR)+ID  AND TH001='A230' AND TG005 IN ('102300','114000')  ),0)  AS '去年本月出貨金額' ");
                STR.AppendFormat(@" ,ISNULL((SELECT SUM(TJ012) FROM  [TK].dbo.COPTJ WITH (NOLOCK),[TK].dbo.COPTI WITH (NOLOCK)  WHERE TI001=TJ001 AND TI002=TJ002 AND  TJ021='Y' AND SUBSTRING(TJ002,1,4)=CAST(YEAR(GETDATE())-1 AS NVARCHAR) AND SUBSTRING(TJ002,1,6)=CAST(YEAR(GETDATE())-1 AS NVARCHAR)+ID AND TJ001='A240' AND TI005 IN ('102300','114000')  ),0)  AS '去年本月退貨金額' ");
                STR.AppendFormat(@" FROM [TKECOMMERCE].dbo.BASEMONTH");
                STR.AppendFormat(@" ) AS TEMP ");
                STR.AppendFormat(@" ");
                STR.AppendFormat(@" ");
