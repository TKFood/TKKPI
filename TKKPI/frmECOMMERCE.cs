    ...
    public partial class frmECOMMERCE : Form
    {
        ...
        public StringBuilder SETsbSql()
        {
            ...
            else if (comboBox1.Text.ToString().Equals("今年現銷累積銷貨"))
            {
                ...
                STR.Append(@" SELECT ID AS '月份'");
                STR.Append(@" ,CAST(YEAR(GETDATE()) AS NVARCHAR)+ID  AS  '今年'");
                STR.Append(@" ,CASE WHEN ID<=MONTH(GETDATE()) THEN ISNULL((SELECT SUM(LA011) FROM  [TK].dbo.COPTH WITH (NOLOCK),[TK].dbo.INVLA WITH (NOLOCK) WHERE  TH020='Y' AND TH001=LA006 AND TH002=LA007 AND TH003=LA008 AND SUBSTRING(TH002,1,4)=CAST(YEAR(GETDATE()) AS NVARCHAR) AND SUBSTRING(TH002,1,6)<=CAST(YEAR(GETDATE()) AS NVARCHAR)+ID AND TH001='A230'),0) ELSE 0 END AS '今年累積出貨量'");
                STR.Append(@" ,CASE WHEN ID<=MONTH(GETDATE()) THEN ISNULL((SELECT SUM(LA011) FROM  [TK].dbo.COPTJ WITH (NOLOCK),[TK].dbo.INVLA WITH (NOLOCK) WHERE TJ021='Y' AND TJ001=LA006 AND TJ002=LA007 AND TJ003=LA008 AND SUBSTRING(TJ002,1,4)=CAST(YEAR(GETDATE()) AS NVARCHAR) AND   SUBSTRING(TJ002,1,6)<=CAST(YEAR(GETDATE()) AS NVARCHAR)+ID AND TJ001='A240'),0)  ELSE 0 END AS '今年累積退貨量'");
                STR.Append(@" ,CASE WHEN ID<=MONTH(GETDATE()) THEN ISNULL((SELECT SUM(TH013) FROM  [TK].dbo.COPTH WITH (NOLOCK) WHERE  TH020='Y' AND SUBSTRING(TH002,1,4)=CAST(YEAR(GETDATE()) AS NVARCHAR) AND SUBSTRING(TH002,1,6)<=CAST(YEAR(GETDATE()) AS NVARCHAR)+ID  AND TH001='A230'),0) ELSE 0 END AS '今年累積出貨金額'");
                STR.Append(@" ,CASE WHEN ID<=MONTH(GETDATE()) THEN ISNULL((SELECT SUM(TJ012) FROM  [TK].dbo.COPTJ WITH (NOLOCK) WHERE  TJ021='Y' AND SUBSTRING(TJ002,1,4)=CAST(YEAR(GETDATE()) AS NVARCHAR) AND SUBSTRING(TJ002,1,6)<=CAST(YEAR(GETDATE()) AS NVARCHAR)+ID AND TJ001='A240'),0)  ELSE 0 END AS '今年累積退貨金額'");
                STR.Append(@" ,CAST(YEAR(GETDATE())-1 AS NVARCHAR)+ID  AS '去年'");
                STR.Append(@" ,ISNULL((SELECT SUM(LA011) FROM  [TK].dbo.COPTH WITH (NOLOCK),[TK].dbo.INVLA WITH (NOLOCK) WHERE  TH020='Y' AND TH001=LA006 AND TH002=LA007 AND TH003=LA008 AND SUBSTRING(TH002,1,4)=CAST(YEAR(GETDATE())-1 AS NVARCHAR) AND SUBSTRING(TH002,1,6)<=CAST(YEAR(GETDATE())-1 AS NVARCHAR)+ID AND TH001='A230'),0) AS '去年累積出貨量'");
                STR.Append(@" ,ISNULL((SELECT SUM(LA011) FROM  [TK].dbo.COPTJ WITH (NOLOCK),[TK].dbo.INVLA WITH (NOLOCK) WHERE  TJ021='Y' AND TJ001=LA006 AND TJ002=LA007 AND TJ003=LA008 AND SUBSTRING(TJ002,1,4)=CAST(YEAR(GETDATE())-1 AS NVARCHAR) AND   SUBSTRING(TJ002,1,6)<=CAST(YEAR(GETDATE())-1 AS NVARCHAR)+ID AND TJ001='A240'),0)   AS '去年累積退貨量'");
                STR.Append(@" ,ISNULL((SELECT SUM(TH013) FROM  [TK].dbo.COPTH WITH (NOLOCK) WHERE  TH020='Y' AND SUBSTRING(TH002,1,4)=CAST(YEAR(GETDATE())-1 AS NVARCHAR) AND SUBSTRING(TH002,1,6)<=CAST(YEAR(GETDATE())-1 AS NVARCHAR)+ID  AND TH001='A230'),0)  AS '去年累積出貨金額'");
                STR.Append(@" ,ISNULL((SELECT SUM(TJ012) FROM  [TK].dbo.COPTJ WITH (NOLOCK) WHERE  TJ021='Y' AND SUBSTRING(TJ002,1,4)=CAST(YEAR(GETDATE())-1 AS NVARCHAR) AND SUBSTRING(TJ002,1,6)<=CAST(YEAR(GETDATE())-1 AS NVARCHAR)+ID AND TJ001='A240'),0)  AS '去年累積退貨金額'");
                STR.Append(@" FROM [TKECOMMERCE].dbo.BASEMONTH ) AS TEMP");
                STR.Append(@" ");
            ...
            else if (comboBox1.Text.ToString().Equals("會計消貨者業績"))
            {
                ...
                STR.Append(@" SELECT ID AS '月份'");
                STR.Append(@" ,CAST(YEAR(GETDATE()) AS NVARCHAR)+ID  AS  '今年'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK), [TK].[dbo].[ACTTA] WITH (NOLOCK) WHERE TA001=TB001 AND TA002=TB002 AND TA010='Y' AND TB005='411104' AND TB006 NOT IN ('106200') AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0)) AS '總消費者'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB019) FROM [TK].[dbo].[ACRTB] WITH (NOLOCK) ,[TK].[dbo].[ACRTA] WITH (NOLOCK) WHERE TA001=TB001 AND TA002=TB002 AND TA004 IN ('2209400100','11110775') AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0))  AS '橘點子'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TH013) FROM  [TK].dbo.COPTH WITH (NOLOCK) WHERE  TH020='Y' AND TH005 NOT LIKE '%手續%'AND TH005 NOT LIKE '%運費%' AND TH001='A233' AND TH002 LIKE  CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'  ),0)) 'WEB'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK) WHERE TB005='411104' AND TB006 IN ('106400','102300') AND (TB010 LIKE '%pc%' OR  TB010 LIKE '%Pc%'  OR  TB010 LIKE '%PC%' ) AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0)) AS 'PCHOME'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK) WHERE TB005='411104' AND TB006 IN ('106400','102300') AND (TB010 LIKE '%神坊%')  AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0)) AS '神坊'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK) WHERE TB005='411104' AND TB006 IN ('106400','102300') AND (TB010 LIKE '%樂天%')  AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0))  AS '樂天'");
                STR.Append(@" ,CONVERT(INT,ISNULL((SELECT SUM(TB004*TB007)*-1 FROM [TK].[dbo].[ACTTB] WITH (NOLOCK) WHERE TB005='411104' AND TB006 IN ('106400','102300') AND (TB010 LIKE '%自游邦%')  AND TB002 LIKE CAST(YEAR(GETDATE()) AS NVARCHAR)+ID+'%'),0))  AS '自游邦'");
                STR.Append(@" FROM [TKECOMMERCE].dbo.BASEMONTH ) AS TEMP");
                STR.Append(@" ");
                STR.Append(@" ");
