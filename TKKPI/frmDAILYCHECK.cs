    ...
    public partial class frmDAILYCHECK : Form
    {
        ...
        public void Search4()
        {
            try
            {
                ...
                sbSql.AppendFormat(@"   AND (ISNULL(ISNULL((SELECT TOP 1 TM010  FROM [TK].dbo.PURTL,[TK].dbo.PURTM WHERE TL001=TM001 AND TL002=TM002 AND TM011='Y' AND TM004=TD004 AND TL004=TC004  ORDER BY TL003 DESC),0),0)<>TD010 OR ISNULL(TB009,0)<>TD011 OR (TD011-TD008*TD010)<>0) ");
