    ...
    public partial class frmDAILYCHECK : Form
    {
        ...
        public void Search4()
        {
            try
            {
                ...
                sbSql.AppendFormat(@"  SELECT MA002,ISNULL((SELECT TOP 1 TM010  FROM [TK].dbo.PURTL,[TK].dbo.PURTM WHERE TL001=TM001 AND TL002=TM002 AND TM011='Y' AND TM004=TD004 AND TL004=TC004 ORDER BY TL003 DESC),0) AS TM010,TD010,(TD010-ISNULL(ISNULL((SELECT TOP 1 TM010  FROM [TK].dbo.PURTL,[TK].dbo.PURTM WHERE TL001=TM001 AND TL002=TM002 AND TM011='Y' AND TM004=TD004 AND TL004=TC004  ORDER BY TL003 DESC),0),0)) AS PDIFF,ISNULL(TB009,0) AS TB009,TD008,TD011,(TD011-TD008*TD010) AS DIFF,TC025,TD001,TD002,TD003,TD004,TD005,TD006,TD008,TD009 ,TD013,TD021,TD023       ,TC004    ");
                ...
                sbSql.AppendFormat(@"   AND (ISNULL(ISNULL((SELECT TOP 1 TM010  FROM [TK].dbo.PURTL,[TK].dbo.PURTM WHERE TL001=TM001 AND TL002=TM002 AND TM011='Y' AND TM004=TD004 AND TL004=TC004  ORDER BY TL003 DESC),0),0)<>TD010 OR ISNULL(TB009,0)<>TD008 OR (TD011-TD008*TD010)<>0) ");
