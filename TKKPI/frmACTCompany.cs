        ...
        public StringBuilder SETsbSql()
        {
            ...
            else if(comboBox1.Text.ToString().Equals("實際與預算比較費用報表"))
            {
                ...
                else
                {
                    ...
                    STR.AppendFormat(@"  FROM ");
                    STR.AppendFormat(@"  ( ");
                    STR.AppendFormat(@"  SELECT '2017' AS '年度','01' AS '月份',TEMP.TB005 AS '科目',MA003 AS '科目名稱','106700' AS '部門代號',ME002 AS '部門'");
                    STR.AppendFormat(@"  ,ISNULL((SELECT (SUM(CONVERT(INT,TB004)*TB007)) FROM [TK].dbo.ACTTA TA,[TK].dbo.ACTTB TB WHERE TA.TA001=TB.TB001 AND TA.TA002=TB.TB002 AND TB.TB005=TEMP.TB005 AND TB006 IN (SELECT MR001 FROM  [TK].dbo.ACTMR WITH(NOLOCK)  WHERE MR002 LIKE (SELECT LTRIM(RTRIM(MR002))+'%' FROM [TK].dbo.ACTMR WITH(NOLOCK)  WHERE MR001 ='106700')   ) AND SUBSTRING(TA003,1,4)='2017' AND SUBSTRING(TA003,5,2)='01'),0) AS '當月實際金額'");
                    STR.AppendFormat(@"  ,CAST(ISNULL((SELECT SUM(MK006) FROM [TK].dbo.ACTMK MK WITH (NOLOCK) WHERE MK.MK003=TEMP.TB005 AND MK.MK002='2017' AND MK.MK005='01'AND MK.MK004 IN  (SELECT MR001 FROM  [TK].dbo.ACTMR WITH(NOLOCK)  WHERE MR002 LIKE (SELECT LTRIM(RTRIM(MR002))+'%' FROM [TK].dbo.ACTMR WITH(NOLOCK)  WHERE MR001 ='106700') ) ),0)  AS DECIMAL(18,2)) AS '當月預算' ");
                    STR.AppendFormat(@"  ,CAST(ISNULL((SELECT SUM(CONVERT(INT,TB004)*TB007) FROM [TK].dbo.ACTTA TA WITH (NOLOCK),[TK].dbo.ACTTB TB WITH (NOLOCK) WHERE TA.TA001=TB.TB001 AND TA.TA002=TB.TB002 AND TB.TB005=TEMP.TB005 AND  TB.TB006 IN (SELECT MR001 FROM  [TK].dbo.ACTMR WITH(NOLOCK)  WHERE MR002 LIKE (SELECT LTRIM(RTRIM(MR002))+'%' FROM [TK].dbo.ACTMR WITH(NOLOCK)  WHERE MR001 ='106700')   )AND SUBSTRING(TA.TA003,1,4)='2017' AND SUBSTRING(TA.TA003,5,2)<='01'),0)  AS DECIMAL(18,2)) AS '實際費用累積'");
                    STR.AppendFormat(@"  ,CAST(ISNULL((SELECT SUM(MK006) FROM [TK].dbo.ACTMK MK WITH (NOLOCK) WHERE MK.MK003=TEMP.TB005 AND MK.MK002='2017' AND MK.MK005<='01'AND MK.MK004 IN  (SELECT MR001 FROM  [TK].dbo.ACTMR WITH(NOLOCK)  WHERE MR002 LIKE (SELECT LTRIM(RTRIM(MR002))+'%' FROM [TK].dbo.ACTMR WITH(NOLOCK)  WHERE MR001 ='106700') ) ),0)  AS DECIMAL(18,2)) AS '費用預算累積' ");
                    STR.AppendFormat(@"  ,CAST(ISNULL((SELECT SUM(MK006) FROM [TK].dbo.ACTMK MK WITH (NOLOCK) WHERE MK.MK003=TEMP.TB005 AND MK.MK002='2017' AND MK.MK004 IN  (SELECT MR001 FROM  [TK].dbo.ACTMR WITH(NOLOCK)  WHERE MR002 LIKE (SELECT LTRIM(RTRIM(MR002))+'%' FROM [TK].dbo.ACTMR WITH(NOLOCK)  WHERE MR001 ='106700') ) ),0)  AS DECIMAL(18,2)) AS '年度預算總額' ");
                    STR.AppendFormat(@"  FROM (");
                    ...
                    STR.AppendFormat(@"  AND TB006 IN (SELECT MR001 FROM  [TK].dbo.ACTMR WITH(NOLOCK)  WHERE MR002 LIKE (SELECT LTRIM(RTRIM(MR002))+'%' FROM [TK].dbo.ACTMR WITH(NOLOCK)  WHERE MR001 ='106700')   )");
                    STR.AppendFormat(@"  AND SUBSTRING(TA003,1,4)='2017' AND SUBSTRING(TA003,5,2)='01'");
                    STR.AppendFormat(@"  UNION ALL");
                    ...
                    STR.AppendFormat(@"  WHERE MR001 ='106700')) ");
                    STR.AppendFormat(@"  AND SUBSTRING(MK001,1,4)='2017' AND SUBSTRING(MK001,5,2)='01') AS TEMP");
                    STR.AppendFormat(@"  LEFT JOIN [TK].dbo.ACTMA WITH (NOLOCK)  ON TB005=MA001 ");
                    STR.AppendFormat(@"  LEFT JOIN [TK].dbo.CMSME WITH (NOLOCK) ON ME001='106700' ");
